PROGRAM menu_program
    ...
    integer :: resultado_grafo, resultado_impresorasMantenimiento
DO
    WRITE(*,*) "===================================================="
    ...
    SELECT CASE (opcion)
        ...
        CASE (2)
            ...
            read (*,*) password
            call avl_sucursales%searchNode(id_sucursal, password)
            ...
            CASE (1)
                ...
                CASE (2)
                    ...
                    read (*,*) destiny_brach
                    resultado_nodos = analizador%get_shortest_path(id_sucursal, destiny_brach)
                    resultado_impresoras = analizador_impresoras%get_longest_path(id_sucursal, destiny_brach)
                    call resultado_nodos%print()
                    resultado_grafo = resultado_nodos%total_weight*80
                    print *, "El peso total del recorrido es: ", resultado_grafo
                    print *, "El total de las impresas en mantenimiento es: ", resultado_nodos%total_printers
                    print *, '----------------------'
                    call resultado_impresoras%print()
                    resultado_impresorasMantenimiento = resultado_impresoras%total_weight*100
                    print *, "El costo total del recorrido con impresoras es: ", resultado_impresorasMantenimiento
                    print *, "La ruta es: ", resultado_impresoras%total_printers
...
SUBROUTINE subMenu_cargaArchivos()
    ...
    SELECT CASE (opcion)
        ...
        CASE (2)
            ...
            call graphRutas%graficar('grafo_route.dot')
            call json%destroy()
